...
function CheckIcon() {
  return (
    <svg
      className="mr-2 h-5 w-5 shrink-0 text-[#d4d4d8]"
      fill="none"
      stroke="currentColor"
      viewBox="0 0 24 24"
      aria-hidden="true"
    ...
    <main className="dpai-page dpai-radial-bg relative overflow-hidden px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        <header className="mb-12 text-center">
          <p className="dpai-label text-[#d4d4d8]">Billing</p>
        ...
        <section className="mx-auto grid max-w-5xl grid-cols-1 gap-6 md:grid-cols-3">
          {(Object.entries(CREDIT_PACKAGES) as [PackageType, typeof CREDIT_PACKAGES[PackageType]][]).map(
            ([key, pkg]) => (
              ...
              >
                {pkg.popular ? (
                  <div className="bg-[#e5e5e5] py-2 text-center text-xs font-semibold uppercase tracking-[0.1em] text-[#071009]">
                    Most Popular
                  </div>
                ) : null}
                ...
                <div className="p-6">
                  ...
                  <div className="mt-5">
                    ...
                    {pkg.discount ? (
                      <span className="mt-3 inline-block rounded-full border border-[#a1a1aa]/35 bg-[#202020] px-2 py-1 text-xs font-semibold text-[#d4d4d8]">
                        {pkg.discount}
                      </span>
                    ) : null}
                  </div>
                  ...
                  <button
                    ...
                    className={`mt-6 w-full rounded-md px-4 py-3 font-semibold transition-colors disabled:cursor-not-allowed disabled:opacity-50 ${
                      pkg.popular
                        ? "bg-[#e5e5e5] text-[#0b0d10] hover:bg-[#f1f1f1]"
